...
class DSCustomPatients implements \Countable, \ArrayAccess, \Iterator, \Stringable, Arrayable
{
    ...
    {
        if (!($value instanceof DSCustomPatient)) {
            throw new \TypeError("Offset type error. Acceptable type is: " . DSCustomPatient::class, 1);
        }
    }
}
