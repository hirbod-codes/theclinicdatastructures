...
class DSAdmin extends DSUser
{
    ...
    {
        return json_decode(file_get_contents(__DIR__ . "/Privileges/adminPrivileges.json"), true);
    }
    ...
    public function getPrivilege(string $privilege): mixed
    {
        ...
        $privileges = json_decode(file_get_contents(__DIR__ . "/Privileges/adminPrivileges.json"), true);
    ...
    public function setPrivilege(string $privilege, mixed $value): void
    {
        ...
        if (file_put_contents(__DIR__ . "/adminPrivileges.json", $privileges) === false) {
