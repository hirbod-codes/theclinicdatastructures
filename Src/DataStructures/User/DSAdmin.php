...
class DSAdmin extends DSUser
{
    ...
    public function getPrivilege(string $privilege): mixed
    {
        ...
        $privileges = json_decode(file_get_contents(self::PRIVILEGES_PATH . "/adminPrivileges.json"), true);
    ...
    public function setPrivilege(string $privilege, mixed $value): void
    {
        ...
        if (($r = file_put_contents(self::PRIVILEGES_PATH . "/adminPrivileges.json", json_encode($privileges))) === false) {
